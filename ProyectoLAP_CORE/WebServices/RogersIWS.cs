...
namespace WebServices
{
    ...
    public interface RogersIWS
    {
        ...
        [OperationContract]
        [WebGet(RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        Boolean WSchangeState(Boolean state, string email);
        ...
        [OperationContract]
        [WebGet(RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        Boolean WSdeleteEmployee(string username);
        ...
        [OperationContract]
        [WebGet(RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        Boolean WSaddproduct(string productname, string description, double price, string image, Boolean isoutofstoc, int category);
        ...
        [OperationContract]
        [WebGet(RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        Boolean WSupdateProduct(int id, string name, string descr, double price, string imageuri, int stock, int cat);
